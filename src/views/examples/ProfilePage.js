  ...
  },
  {
    ...
    info: [
      [
        "2021",
        "크라운 샤이니스, 갤러리 아원, 서울",
        "특별기획전 <귀걸이, 과거와 현재를 꿰다>, 서울공예박물관, 서울",
        "블루. 불확실한 봄, 갤러리 바움 & 카메라타 아트 스페이스, 파주",
        "GUESS WHAT, Elisabeth Habig, 비엔나, 오스트리아",
      ],
      [
        "2020",
        "Silver Winter Seasons, 식물관PH, 서울",
        "‘순라길 예술이 되다’ - 순라길 공예페어, 서울주얼리지원센터 2관, 서울",
        "Lighten Up! - 주얼릭 론도, 크래프트 온 더 힐, 서울",
        "BKV-Prize 2020 for Young Applied Arts, 뮌헨, 독일",
      ],
      [
        "2019 ",
        "Our necklace guide - 주얼릭 론도, 공예트렌드페어, 서울",
        "뜰에 깃들, 이유진 갤러리, 서울",
        "곽동준, 김희앙 - 선물전, 갤러리 이마주, 서울 ",
        "따로 또 같이, 산울림 아트 앤 크래프트, 서울",
        "아날로그_디지털, 갤러리 바움, 파주",
        "720 Degrees, SNAG Chicago, Adorned spaces, 시카고, 미국",
        "아트마이닝 파리-레벨라시옹, 그랑 팔레, 파리, 프랑스",
        "아트마이닝 밀라노, 팔라초 리타, 밀라노, 이탈리아",
        "콜렉트, 한국공예∙디자인문화진흥원, 사치 갤러리, 런던, 영국",
      ],
      [
        "2018 ",
        "SOFA 아트 페어, 한국공예∙디자인문화진흥원, 네이비 피어, 시카고, 미국",
        "사소한 사건들, 의외의 조합, 서울 ",
        "아트마이닝 서울, DDP, 서울",
        "Jewelry breeze, 515 갤러리, 광주 ",
        "반지수집, 갤러리 안, 서울",
        "천지만물:EVERYTHING UNDER THE SUN, 갤러리 토스트, 서울",
        "-ing Creative Festival, Creative Market, 두바이, 아랍에미리트",
      ],
      [
        "2017 ",
        "김희앙 장신구, 공예트렌드페어 창작공방관, 코엑스, 서울",
        "V&A Museum - 한국공예∙디자인문화진흥원 교류협력 워크숍 선정, 런던, 영국",
        "Our Earring Guide, KCDF 갤러리, 서울",
        "오너먼테이션, 유리지공예관, 서울",
      ],
      [
        "2016  ",
        "White Christmas, Galeria Tereza Seabra, 리스본, 포르투갈",
        "주얼릭 론도, 공예트렌드페어, 코엑스, 서울, 대한민국",
        "20/20, Kath Libbert Jewellery Gallery, 브래드포드, 영국",
        "ART OF AURA, 텀트리 프로젝트, 대구",
        "메종 & 오브제, 한국공예∙디자인문화진흥원, 파리 노르 빌팽트, 프랑스",
      ],
      [
        "2015 ",
        "김희앙 장신구, 공예트렌드페어 창작공방관, 코엑스, 서울",
        "주얼릭 론도, JOYA Barcelona Art Jewellery Fair, Arts Santa Monica, 바르셀로나, 스페인",
        "BKV-Prize 2015 for Young Applied Arts, 뮌헨, 독일",
        "Marzee International Graduate Show, Galerie Marzee, 네이메헨, 네덜란드",
        "대만 국제 금속공예 공모전, Gold Museum, 신베이, 대만",
        "청년조각가 기획초대전 '북한강을 바라보며', 서호미술관, 남양주",
      ],
      [
        "2012 ",
        "위시리스트, 성곡미술관, 서울",
        "알케미스츠 - 물질의 신화, KCDF 갤러리, 서울",
        "80-89 감성이미지, 성곡미술관, 서울",
      ],
    ].map((obj) => {
